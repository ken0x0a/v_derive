...
pub fn bool_literal_stmt(val bool) ast.Stmt {
	return ast.ExprStmt{expr: bool_literal(val)}
}
...
pub fn array_init_void() ast.Expr {
	return ast.ArrayInit{typ: ast.void_type, elem_type: ast.void_type}
}
// get `[]` as Stmt
pub fn array_init_void_stmt() ast.Stmt {
	return ast.Stmt(ast.ExprStmt{expr:array_init_void()})
}